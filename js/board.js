(function () {
  ...
  const MAX_SCALE = 3.5;
  const photos = [
    { src: "images/img1.png", alt: "Friendship Keychains", category: "Jewelry", description: "I love to creating matching keychains to keep as a reminder of our friendship, personalizing each chain's color and charms.", left: 23.6, top: 29.3, width: 9.3, height: 19.1 },
    { src: "images/img10.png", alt: "Docs Documentary", category: "Film", description: "A documentary about a Korean immigrant doctor who shares her journey of how she immigrated to America and her struggles as she created a path for herself. Role: Director, Editor", left: 35.2, top: 30.5, width: 5.5, height: 8 },
    { src: "images/img3.png", alt: "Charm Bracelet", category: "Jewelry", description: "Designing my jewelry first starts with choosing which charms I want to use first, then laying out how I want to final product to look.", left: 43.3, top: 29.4, width: 14.1, height: 9.1 },
    { src: "images/img11.png", alt: "Until: an OS-level experience", category: "UX Design", description: "Originally for an interview challenge, I created an OS-level experience for when users reach 20% left on their mobile devices. This presentation was just the start of an idea.", left: 59.6, top: 31.5, width: 6.8, height: 11 },
    { src: "images/img12.png", alt: "Muay Thai", category: "Activity", description: "I started Muay Thai in high school and ended up joining the Muah Thai at Univesity of Michigan, where I'm not Secretary of the club. Muay Thai continues to teach me resilience, discipline, and respect through physical and mental challenges.", left: 67.3, top: 29.3, width: 9.5, height: 19.1 },
    { src: "images/img6.png", alt: "Necklace/Headpiece for Photoshoot", category: "Jewelry", description: "I handmade a necklace that I used as a headpiece for a photoshoot for MA:E Magazine, Volume 19, where it ended up as the front cover. Role: video, styler", left: 35.2, top: 41.4, width: 5.4, height: 10.2 },
    { src: "images/img15.png", alt: "Designing Portfolio Websites", category: "UX Design", description: "I designed a fully functional portfolio website on Figma that showcases pages of the individual's works, resume, and bio.", left: 59.5, top: 46.8, width: 5, height: 12.3 },
    { src: "images/img8.png", alt: "MA:E Photoshoot", category: "Film", description: "I filmed and edited a short-reel video for MA:E Magazine's Instagram for their 19th Volume.", left: 67.3, top: 52.2, width: 8.2, height: 7 },
    { src: "images/img9.png", alt: "Learning Curve: high school film", category: "Film", description: "A student-led, feature-length film about a senior girl's world turning upside down when her high school dropout dad, newly laid off, returns to high school with her to receive his diploma. Role: Head of Sound Department, sound mixer", left: 23.5, top: 55, width: 13.4, height: 18.3 },
    { src: "images/img16.png", alt: "Magnet Collection", category: "Activity", description: "My growing wall of magnets, collected from places across the U.S. and the world, is less about the magnets themselves and more about the stories behind each one. It's the same curiosity about the people and places that drives how I approach design.", left: 38.3, top: 56.6, width: 4.2, height: 15.1 },
    { src: "images/img7.png", alt: "MA:E Photoshoot", category: "Film", description: "I filmed and edited a short-reel video for MA:E Magazine's Instagram for their 20th Volume.", left: 44.5, top: 62.9, width: 4.5, height: 10 },
    { src: "images/img77.png", alt: "Keychains for Family", category: "Jewelry", description: "I created matching keychains for my family members back in Korea. Although it took a while to make it all, the ability to turn creativity into something tangible and functional became an outlet to express my ideas while considering how others used what I made.", left: 50.7, top: 61, width: 8.1, height: 12.2 },
    { src: "images/img14.png", alt: "High School Theater", category: "Activity", description: "I co-stage-managed two high school musical productions: Little Shop of Horrors and Mean Girls. As Stage Manager for my school's theater department, I led crews across lighting, sound, and set design, learning how to coordinate people, timing, and technical systems under live-performance pressure.", left: 61.6, top: 63.1, width: 15.2, height: 12.1 },
  ];
